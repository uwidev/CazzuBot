"""Demonstration of how to write a extension for CazzuBot."""
...
class Echo(commands.Cog):
	...
	async def echo(self, ctx, *, content: str):
		...
		#
		# Anything past that are arguments to pass into the command as individual
		# parameters and will always be strngs UNLESS you convert it.
		# See about converters: https://discordpy.readthedocs.io/en/stable/ext/commands/commands.html#converters
		#
		# `*, content: str`
		# The last two arguments are special. `*` grabs the rest of the arguments and
		# puts it into the variable content.

		# To send a message back to the channel the command was used in, just send it
		# back to the context.
