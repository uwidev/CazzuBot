...
Each page is a short, concrete walkthrough.
 ...
 -  [create a new plugin](./how-do-i/create-a-plugin.md)
 -  [add dependencies](./how-do-i/add-dependencies.md)
 -  [add a schema](./how-do-i/add-a-schema.md)
 -  [add scheduled work](./how-do-i/add-scheduled.md)
 -  [hook into Discord (./how-do-i/extensions)](hook-into-discord.md)
 -  [add a command group with admin gating](./how-do-i/add-a-command-group.md)
 -  [read & write settings](./how-do-i/read-write-settings.md)
 -  [send templated messages](./how-do-i/send-templated-messages.md)
 -  [emit & listen to domain events](./how-do-i/emit-listen-events.md)
 -  [grant & consume items at runtime](./how-do-i/grant-consume-items.md)
 -  [add persistent buttons & modals](./how-do-i/persistent-buttons-modals.md)
 -  [write a plugin test](./how-do-i/write-a-plugin-test.md)
 -  [add a new asset](./how-do-i/add-an-asset.md)
 -  [add a new item](./how-do-i/add-an-item.md)
 -  [add a new frog species](./how-do-i/add-a-frog-species.md)
