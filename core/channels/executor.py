...
from core.channels.export import QUALITY_VALUES
from core.channels.parser import (
    ChannelSpec,
)
from core.channels.plan import (
    Plan,
    RenameOp,
    bucket_of,
)
from core.channels.snapshot import (
    ChannelSnapshot,
    SLOWMODE_KINDS,
    VOICE_KINDS,
    representable_name,
)
from core.manifest.executor import (
    REORDER_ATTEMPTS,
    REORDER_SETTLE,
    ApplyResult,
)
...
async def reorder_guild(
    ...
    channel-name order (see ``core.channels.plan``); ``managed_ids``
