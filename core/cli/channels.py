...
Thin shell: the parser/plan/executor stay in the ``core.channels``
engine and the verbs live in ``core.manifest.cli`` — this module
...
from core.channels.plan import Plan, build_plan
