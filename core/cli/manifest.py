...
from core.cli.snapshot import SNAPSHOT_PATH
from core.manifest.cli import add_file_args
from core.roles.export import render_manifest
from core.roles.parser import ManifestError, parse
...
async def cmd_render(args: argparse.Namespace) -> int:
    ...
    text = render_manifest(
        ...
        source=f"{SNAPSHOT_PATH} by core.cli manifest render",
