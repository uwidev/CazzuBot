"""Single-entry admin CLI.
    ...
    python -m core.cli <domain> <verb> [options]
...
``core/cli/`` exposing a :class:`~core.cli.core.Domain`.
"""
...
from core.cli import channels, manifest, roles, snapshot
from core.cli.core import Domain, LiveHandler, with_client
